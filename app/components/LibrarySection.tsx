...
import { Clock, Flame, Star, ChevronDown, Loader2 } from "lucide-react";
...
export default function LibrarySection() {
  ...
  const sortedWorkouts = [...workouts].sort((a, b) => {
    if (sortBy === "Duration") return parseNumber(a.duration) - parseNumber(b.duration);
  ...
  return (
    <section id="library" className="w-full bg-[#0d0d0e] py-16 px-6 md:px-12 text-white">
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-24 text-zinc-400">
            <Loader2 size={36} className="animate-spin text-[#ccff00] mb-3" />
                    ...
                    <div>
                      ...
                      <p className="text-zinc-400 text-xs mt-1">
                        ...
                        <span className="text-zinc-300">
                          {Array.isArray(workout.equipment) ? workout.equipment.join(", ") : workout.equipment || "Bodyweight"}
                        </span>
                      </p>
                    </div>
